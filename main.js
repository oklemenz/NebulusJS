...
p8_gfx_dat = {
  ...
  "p8b_crt": "data:image/png;base64,",
...
function p8_update_layout() {
  ...
  // pixel perfect: quantize to closest multiple of 256
...
function p8_toggle_crt() {
  var canvas = document.getElementById("canvas");
  var crtcanvas = document.getElementById("crtcanvas");
  if (crtcanvas == null) {
    p8_crt_effect_init(canvas);
  } else {
    canvas.parentNode.removeChild(crtcanvas);
